...
####C:Firstly optimize for the choice of number of unwanted variance factors and empirical genes in order to decide the best parameters for RUVSeq normalization
